...
def parse_verses(block: list) -> dict:
    ...
    for i in range(1, len(parts) - 1, 2):
        ...
        # Menge-Bibel-Versunterteile ("a ", "b " usw.) entfernen:
        #   am Versanfang: "a Dies ist..." → "Dies ist..."
        #   eingebettet nach Satzzeichen: "...Wehen.« b »Gebt..." → "...Wehen.« »Gebt..."
        #   (Lookbehind verhindert False-Positives bei "Das a ist kein Label")
